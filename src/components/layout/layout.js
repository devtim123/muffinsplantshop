  ...
  useEffect(() => {
    if (isOpenCart) {
      document.body.setAttribute(
        "style",
        "overflow-y:hidden; position: fixed; left: 0; right: 0"
      )
    } else {
      ...
      <div className={styles.layout}>
        ...
        <footer className={styles.layout__footer}>
          <div className={styles.layout__footerLinks}>
            <Link className={styles.layout__footerLink} to="/delivery-info">
              Delivery Info
            </Link>
            <Link className={styles.layout__footerLink} to="/about">
              About
            </Link>
            <a
      ...
      {isOpenCart && (
        <div
          style={{
            ...
            maxWidth: 400,
            height: `100vh`,
            boxShadow: `-4px 0px 2px 0px rgba(0,0,0, 0.12)`,
            overflowY: `auto`,
          }}
        >
          <Cart />
