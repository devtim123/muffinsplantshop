    ...
    <Layout location={location}>
      ...
      <div className={styles.products__container}>
        ...
        <div>
          ...
          <p className={styles.products__descriptionBrief}>
            ...
            return (
              <span key={_size.label}>
                ...
                <label htmlFor={_size.label}>
                  <span className={styles.products__sizeLabel}>
                    {_size.label}
                  </span>
                  <span className={styles.products__sizeDescription}>
                    {_size.longDescription}
                  </span>
                </label>
              </span>
            )
